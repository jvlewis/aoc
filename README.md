...
> *f the bitmask bit is 0, the corresponding memory address bit is **unchanged.** >*If the bitmask bit is 1, the corresponding memory address bit is **overwritten with 1.** > \*If the bitmask bit is X, the corresponding memory address bit is **floating.**
